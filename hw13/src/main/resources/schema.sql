...
------------------- Spring Security ACL DB DDL SQL Script -----------------------------------------
...
ALTER TABLE acl_object_identity
    ADD CONSTRAINT fk_object_class FOREIGN KEY (object_id_class) REFERENCES acl_class(id);
ALTER TABLE acl_object_identity
    ADD CONSTRAINT fk_owner_sid FOREIGN KEY (owner_sid) REFERENCES acl_sid(id);
ALTER TABLE acl_object_identity
    ADD CONSTRAINT fk_id_parent FOREIGN KEY (parent_object) REFERENCES acl_object_identity(id);

-- Add foreign keys for acl_entry
ALTER TABLE acl_entry
    ADD CONSTRAINT fk_obj_identity FOREIGN KEY (acl_object_identity) REFERENCES acl_object_identity(id);
ALTER TABLE acl_entry
    ADD CONSTRAINT fk_acl_sid FOREIGN KEY (sid) REFERENCES acl_sid(id);